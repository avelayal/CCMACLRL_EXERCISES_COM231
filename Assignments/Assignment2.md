...
| y*i - y*predict      |  y*i - y*(predict)^2      |
| --------------------|---------------| 
| 52 - 52.2 = 0.2 | 0.2^2 = 0.04       | 
| 57 - 56.6 = 0.4 | 0.4^2 = 0.16       | 
| 61 - 61 = 0 |0^2 = 0       | 
| 65 - 65.4 = 0.4 | 0.4^2 = 0.16       | 
| 70 - 69.8 = 0.2 | 0.2^2 = 0.04       | 

$$
**SSE** = 0.04 + 0.16 + 0 + 0.16 + 0.04 = ***0.4***
$$
